...
class Card {
	constructor(proj, parentDom, modal, expanded) {
		...
		this.deleteBtn.dom.addEventListener("click", (e) => {
			...
			_Storage__WEBPACK_IMPORTED_MODULE_0__.myStorage.deleteProject(this.id, "active");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Expanded)
/* harmony export */ });
...
class Expanded {
	constructor(editModal) {
		...
		deleteBtn.addEventListener("click", (e) => {
			...
			_Storage__WEBPACK_IMPORTED_MODULE_1__.myStorage.deleteProject(this.id, "active");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ModifyModal)
/* harmony export */ });
/* harmony import */ var _Storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Storage */ "./src/modules/Storage.js");
	...
	constructor() {
		...
		submitProjBtn.addEventListener("click", (e) => {
			...
			if (this.editMode !== true) {
				...
				let newDataStored = _Storage__WEBPACK_IMPORTED_MODULE_0__.myStorage.addProjectData(data, "active");
				...
				// 	}
				// } else {
				let newDataStored = _Storage__WEBPACK_IMPORTED_MODULE_0__.myStorage.editProjectData(data, "active");
				this.card.editCard(newDataStored);
				this.turnOffEditMode();
				// }
			}
...
/* harmony export */ });
/* harmony import */ var _ModifyModal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ModifyModal */ "./src/modules/ModifyModal.js");
/* harmony import */ var _Expanded__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Expanded */ "./src/modules/Expanded.js");
...
class View {
	constructor() {
		...
		this.modal = new _ModifyModal__WEBPACK_IMPORTED_MODULE_0__["default"]();
		this.expanded = new _Expanded__WEBPACK_IMPORTED_MODULE_1__["default"](this.modal);
		...
		ascendingBtn.addEventListener("click", (e) => {
			...
			if (this.currentSort !== "ascending") {
				...
				_Storage__WEBPACK_IMPORTED_MODULE_3__.myStorage.sortByDue("ascending");
		...
		descendingBtn.addEventListener("click", (e) => {
			...
			if (this.currentSort !== "descending") {
				...
				_Storage__WEBPACK_IMPORTED_MODULE_3__.myStorage.sortByDue("descending");
		...
		alphabeticalBtn.addEventListener("click", (e) => {
			...
			if (this.currentSort !== "alpha") {
				...
				_Storage__WEBPACK_IMPORTED_MODULE_3__.myStorage.sortByAlpha();
		...
		if (activeProjects.length > 0) {
			...
			activeProjects.forEach((project) => {
				if (project.completed === false || !project.completed) {
					...
					let newCard = new _Card__WEBPACK_IMPORTED_MODULE_2__.Card(
						project,
...
class App {
	constructor() {
		this.view = new _modules_View__WEBPACK_IMPORTED_MODULE_0__["default"]();
	}
}
new App();
