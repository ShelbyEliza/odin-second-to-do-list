...
/* harmony import */ var _formatDate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./formatDate */ "./src/modules/formatDate.js");
...
class Card {
	constructor(proj, parentDom, modal, expanded) {
		...
		let dateView = (0,_formatDate__WEBPACK_IMPORTED_MODULE_1__.formatDateView)(proj.dueDate);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   formatDateView: () => (/* binding */ formatDateView),
/* harmony export */   formatNewDate: () => (/* binding */ formatNewDate)
/* harmony export */ });
...
function formatDateView(date) {
	return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(formatNewDate(date)), "MMMM dd, yyyy");
}
...
class Modal {
	...
	createToDoDom(newToDo) {
		let tempDiv = new _card__WEBPACK_IMPORTED_MODULE_1__.HTMLElement("div", "temp-to-do-div", "", toDoDiv);
...
class ProjectExpanded {
	...
	createToDoDom(toDos) {
		toDos.forEach((toDo) => {
			new _card__WEBPACK_IMPORTED_MODULE_0__.HTMLElement("li", "to-do-item", toDo, this.toDoWrapper);
		});
	}
}
...
/* harmony export */   sortByDue: () => (/* binding */ sortByDue)
/* harmony export */ });
...
/* harmony import */ var _formatDate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./formatDate.js */ "./src/modules/formatDate.js");
...
function sortByDue(setting) {
	...
	if (setting === "ascending") {
		storage.active.sort((a, b) => {
			return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(
				new Date((0,_formatDate_js__WEBPACK_IMPORTED_MODULE_0__.formatNewDate)(a.dueDate)),
				new Date((0,_formatDate_js__WEBPACK_IMPORTED_MODULE_0__.formatNewDate)(b.dueDate))
			);
		});
	} else {
		storage.active.sort((a, b) => {
...
/* harmony import */ var _projectExpanded__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./projectExpanded */ "./src/modules/projectExpanded.js");
/* harmony import */ var _card__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./card */ "./src/modules/card.js");
/* harmony import */ var _storageHelper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./storageHelper */ "./src/modules/storageHelper.js");
...
class View {
	constructor(storage) {
		...
		this.expanded = new _projectExpanded__WEBPACK_IMPORTED_MODULE_1__["default"](this.modal);

		ascendingBtn.addEventListener("click", (e) => {
			e.preventDefault();
			if (this.currentSort !== "ascending") {
				(0,_storageHelper__WEBPACK_IMPORTED_MODULE_3__.sortByDue)("ascending", this);
		...
		descendingBtn.addEventListener("click", (e) => {
			...
			if (this.currentSort !== "descending") {
				(0,_storageHelper__WEBPACK_IMPORTED_MODULE_3__.sortByDue)("descending", this.view);
		...
		alphabeticalBtn.addEventListener("click", (e) => {
			...
			if (this.currentSort !== "alpha") {
				(0,_storageHelper__WEBPACK_IMPORTED_MODULE_3__.sortByAlpha)(this.view);
		...
		if (activeProjects.length > 0) {
			...
			activeProjects.forEach((project) => {
				if (project.priority === false) {
					new _card__WEBPACK_IMPORTED_MODULE_2__.Card(project, projectListWrapper, this.modal, this.expanded);
				} else if (project.priority === true) {
					new _card__WEBPACK_IMPORTED_MODULE_2__.Card(project, priorityListWrapper, this.modal, this.expanded);
				}
			});
		}
	}
...
class App {
	constructor() {
		...
		this.view = new _modules_switchView__WEBPACK_IMPORTED_MODULE_1__["default"](this.projectStorage);
	}
}
new App();
